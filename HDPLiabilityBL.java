package enlj.p106trading.mssqlv51.p10651basketball.rbhdpliability.logics;
...
public class HDPLiabilityBL extends MSELogic
{
    /* Module Id */
    private final String kModuleId = "106510403";    	
    
	/* Task Ids */
	private final String kInitData	    = "10651040301";
	private final String kBetTypes      = "10651040304";
	private final String kEvents        = "10651040305";
	private final String kSmartMaster   = "10651040306";
	private final String kSmartGroup    = "10651040307";
	private final String kLiability     = "10651040308";
    private final String kLiability_TH	= "10651040309";

	/* Server Row Names */
	private final String kSR_BetTypes       = "sr1";
    private final String kSR_Events         = "sr2";
    ...
    /* Common list Fields */
    private final int f_CDFromDate      = 0;
    private final int f_CDToDate        = 1;
    private final int f_CDCompanyUnitId	= 2;
        
    /* Liability list Fields */
    private final int f_LLFromDate          = 0;
    private final int f_LLToDate            = 1;
    private final int f_LLIsLive            = 2;
    private final int f_LLBetTypeIds        = 3;
    private final int f_LLEventIds          = 4;
    private final int f_LLSmartGroupIds     = 5;
    private final int f_LLSmartMasterIds    = 6;
    private final int f_LLCurrentTimeStamp  = 7;
    private final int f_LLCompanyUnitId		= 8;
        
   	public HDPLiabilityBL ()
	{
		super ();		
	}
    ...
    */   
    ...
    private String getLiability ()
    {
        ...
        {  
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getStatusXML (T8_Liability, 1, "HDPLiabilityBL:getLiability:Successful"));
            }
            else
                oBuffer.append (getStatusXML (T8_Liability, -1, "HDPLiabilityBL:getLiability:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (T8_Liability, -1, "HDPLiabilityBL:getLiability" + oException.toString ()));
        }
    ...
    private String getLiability_TH ()
    {
        ...
        {  
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getCurrentTimeStamp ());
                oBuffer.append (getStatusXML (T9_Liability_TH, 1, "HDPLiabilityBL:getLiability_TH:Successful"));
            }
            else
                oBuffer.append (getStatusXML (T9_Liability_TH, -1, "HDPLiabilityBL:getLiability_TH:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (T9_Liability_TH, -1, "HDPLiabilityBL:getLiability_TH" + oException.toString ()));
        }
    ...
    {
        String oFromDate = arrInfo [f_LLFromDate] + " 00:00:00";
	    String oToDate = arrInfo [f_LLToDate] + " 23:59:59";
        
        String oSQL =             
            " Select en_0651c03_liabilityah_bbl.smartid, " +
                ...
                " en_0651c03_liabilityah_bbl.scheduleid, " +
                ...
                " en_0651c03_liabilityah_bbl.leagueid, " +
                " en_0651c03_liabilityah_bbl.leaguename, " +
                " en_0651c03_liabilityah_bbl.ateamname, " +
                " en_0651c03_liabilityah_bbl.bteamname, " +
                " Sum (en_0651c03_liabilityah_bbl.stake * account_currateinfo.currencyrate) As stake, " +
                ...
                " Sum (en_0651c03_liabilityah_bbl.home * account_currateinfo.currencyrate) As homeliability, " +
	            " Sum (en_0651c03_liabilityah_bbl.away * account_currateinfo.currencyrate) As awayliability, " + 
	            " en_0651b10_resultinfo_bbl.ft_ascore, " +
	            " en_0651b10_resultinfo_bbl.ft_bscore, " +
	            " Case When DateAdd (mi, 0, GetDate ()) > DateAdd (mi, " + ConstantsUtil.kTimeCutOff_Bbl + ", en_0651c02_betstatus_bbl.scheduledate) Then 2 Else " +
	                " Case When DateAdd (mi, 0, GetDate ()) Between DateAdd (mi, 0, en_0651c02_betstatus_bbl.scheduledate) And DateAdd (mi, " + ConstantsUtil.kTimeCutOff_Bbl + ", en_0651c02_betstatus_bbl.scheduledate) Then 1 Else 0 End " +
                " End As livestatus " +
            " From en_0651c03_liabilityah_bbl, en_0651c02_betstatus_bbl, en_0651b10_resultinfo_bbl, " +
	            " en_0651b04_smartgroupinfo, en_0151z00_currency, en_0651z00_currencyrates As group_currateinfo, " +  
	            " en_0651z00_currencyrates As account_currateinfo, en_0251z00_bettype WITH (NOLOCK) " +
            " Where en_0651c03_liabilityah_bbl.betrefid = en_0651c02_betstatus_bbl.betrefid And " +
                " en_0651c02_betstatus_bbl.scheduleid = en_0651b10_resultinfo_bbl.scheduleid And " +
	            ...
	            " account_currateinfo.currencyid = en_0651c03_liabilityah_bbl.currencyid And " +
                ...
                " en_0251z00_bettype.mainbettypeid = " + SportUtil.kBMBT_Handicap + " And " +
                " en_0651b04_smartgroupinfo.unitid = " + arrInfo [f_LLCompanyUnitId] +
            ...
            " Group By en_0651c03_liabilityah_bbl.smartid, " +
                " en_0651b04_smartgroupinfo.groupcode, " +
                " en_0651b04_smartgroupinfo.fgcolor, " +
                " en_0651b04_smartgroupinfo.bgcolor, " +
                " en_0151z00_currency.currencyid, " +
	            ...
	            " Case When DateAdd (mi, 0, GetDate ()) > DateAdd (mi, " + ConstantsUtil.kTimeCutOff_Bbl + ", en_0651c02_betstatus_bbl.scheduledate) Then 2 Else " +
	                " Case When DateAdd (mi, 0, GetDate ()) Between DateAdd (mi, 0, en_0651c02_betstatus_bbl.scheduledate) And DateAdd (mi, " + ConstantsUtil.kTimeCutOff_Bbl + ", en_0651c02_betstatus_bbl.scheduledate) Then 1 Else 0 End " +
                " End " +
            " Order By en_0651b04_smartgroupinfo.groupcode, en_0651c03_liabilityah_bbl.ateamname ";
	...
	private String getRefreshSmartIds (String [] arrInfo)
    {
        ...
        try
        {
            String oFromDate = arrInfo [f_LLFromDate] + " 00:00:00";
		    String oToDate = arrInfo [f_LLToDate] + " 23:59:59";
		    String oCurrentTimeStamp = arrInfo [f_LLCurrentTimeStamp];
            
            String oSQL =             
                " Select Distinct en_0651c03_liabilityah_bbl.smartid " +	       
                " From en_0651c03_liabilityah_bbl, en_0651b04_smartgroupinfo, en_0651c02_betstatus_bbl WITH (NOLOCK) " +
                " Where en_0651c03_liabilityah_bbl.smartid = en_0651b04_smartgroupinfo.smartid And " +
	                " en_0651c02_betstatus_bbl.scheduleid = en_0651c03_liabilityah_bbl.scheduleid And " +
        ...
        {
            log ("HDPLiabilityBL:getRefreshSmartIds:" + oException.toString ());
        }
    ...
    private String getLiabilityCondition (String [] arrInfo)
	{
        ...
        int nLiveStatus = convertToInt (arrInfo [f_LLIsLive]);
		if (nLiveStatus > -1)
			oCondition += " And en_0651c02_betstatus_bbl.islive = " + nLiveStatus;
			
		String oBetTypeIds = arrInfo [f_LLBetTypeIds];
		if (oBetTypeIds.equals ("0") == false)
			oCondition += " And en_0651c03_liabilityah_bbl.bettypeid In (" + oBetTypeIds + ") ";

		String oEventIds = arrInfo [f_LLEventIds];
		if (oEventIds.equals ("0") == false)
			oCondition += " And en_0651c03_liabilityah_bbl.scheduleid In (" + oEventIds + ") ";
			
		String oSmartGroupIds = arrInfo [f_LLSmartGroupIds];
		if (oSmartGroupIds.equals ("0") == false)
			oCondition += " And en_0651b04_smartgroupinfo.smartid In (" + oSmartGroupIds + ") ";
			
		String oSmartMasterIds = arrInfo [f_LLSmartMasterIds];
		...
		String oSmartMasterIds_PM = objSmartMasterPM.getUserSmartMasterIds_PM (getUserId (), kModuleId, SportUtil.kS_BasketBall, convertToInt (arrInfo [f_LLCompanyUnitId]));
		...
		String oSmartGroupIds_PM = objSmartGroupPM.getUserSmartGroupIds_PM (getUserId (), kModuleId, SportUtil.kS_BasketBall, convertToInt (arrInfo [f_LLCompanyUnitId]));
	...
	private String getThreadCondition (String [] arrInfo, boolean bThread)
	{
		...
		if (bThread)
        {
		    ...
		    oCondition = " And en_0651c03_liabilityah_bbl.smartid In (" + oSmartIds + ") ";
        } 
    ...
    private String getCurrentTimeStamp ()
    {
        ...
        try
        {
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getStatusXML (GT_TimeStamp, 1, "HDPLiabilityBL:getCurrentTimeStamp:Successful"));
            }
            else
                oBuffer.append (getStatusXML (GT_TimeStamp, -1, "HDPLiabilityBL:getCurrentTimeStamp:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (GT_TimeStamp, -1, "HDPLiabilityBL:getCurrentTimeStamp" + oException.toString ()));
        }
    ...
    private String getBetTypes ()
    {
        ...
        {           
            ...
            String oFromDate = arrInfo [f_CDFromDate] + " 00:00:00";
		    String oToDate = arrInfo [f_CDToDate] + " 23:59:59";
		    
            String oSQL =             
                " Select Distinct en_0251z00_bettype.bettypeid, " +
	                " en_0251z00_bettype.bettype_" + getLanguage () +
                " From en_0251z00_bettype, en_0651c03_liabilityah_bbl, en_0651c02_betstatus_bbl WITH (NOLOCK), en_0251b02_accountinfo " +
                " Where en_0251z00_bettype.bettypeid = en_0651c03_liabilityah_bbl.bettypeid And " +
                    " en_0651c03_liabilityah_bbl.bettypeid = en_0651c02_betstatus_bbl.bettypeid And " +
                    " en_0651c02_betstatus_bbl.scheduleid > 0 And " +
                    " en_0251z00_bettype.mainbettypeid = " + SportUtil.kBMBT_Handicap + " And " +
                    " en_0651c02_betstatus_bbl.accountid = en_0251b02_accountinfo.accountid And " +
					" en_0251b02_accountinfo.unitid = " + arrInfo [f_CDCompanyUnitId] + 
                    getDateCondition_PB (oFromDate, oToDate) +
                    getIgnoreClientCondition () +
                " Order By bettypeid ";
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getStatusXML (T4_BetTypes, 1, "HDPLiabilityBL:getBetTypes:Successful"));
            }
            else
                oBuffer.append (getStatusXML (T4_BetTypes, -1, "HDPLiabilityBL:getBetTypes:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (T4_BetTypes, -1, "HDPLiabilityBL:getBetTypes" + oException.toString ()));
        }
    ...
    private String getEvents ()
    {
        ...
        {            
            ...
            String oSQL = 
                ...
                " From en_0651c02_betstatus_bbl, en_0651c03_liabilityah_bbl, en_0251z00_bettype WITH (NOLOCK), en_0251b02_accountinfo " +
                " Where en_0651c02_betstatus_bbl.scheduleid = en_0651c03_liabilityah_bbl.scheduleid And " +
					" en_0251z00_bettype.bettypeid = en_0651c02_betstatus_bbl.bettypeid And " +
	                " en_0251z00_bettype.mainbettypeid = " + SportUtil.kBMBT_Handicap + " And " +
                    " en_0651c02_betstatus_bbl.scheduleid > 0 And " +
                    " en_0651c02_betstatus_bbl.accountid = en_0251b02_accountinfo.accountid And " +
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getStatusXML (T5_Events, 1, "HDPLiabilityBL:getEvents:Successful"));
            }
            else
                oBuffer.append (getStatusXML (T5_Events, -1, "HDPLiabilityBL:getEvents:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (T5_Events, -1, "HDPLiabilityBL:getEvents" + oException.toString ()));
        }
    ...
    private String getSmartMasters ()
    {
        ...
        try
        {
			...
			UserSmartMasterPM_T1 objSmartMasterPM = new UserSmartMasterPM_T1 (getDocument ());
			String oSmartMasterIds_PM = objSmartMasterPM.getUserSmartMasterIds_PM (getUserId (), kModuleId, SportUtil.kS_BasketBall, convertToInt (arrInfo [f_CDCompanyUnitId]));
            ...
            String oSQL =             
                ...
                " From en_0651b04_smartmasterinfo, en_0651b04_smartgroupinfo, " +
                    " en_0651c02_betstatus_bbl, en_0651c03_liabilityah_bbl, en_0251z00_bettype WITH (NOLOCK) " +
                " Where en_0651b04_smartmasterinfo.smartid = en_0651b04_smartgroupinfo.mastergroupid And " +
                    ...
                    " en_0651b04_smartgroupinfo.smartid = en_0651c03_liabilityah_bbl.smartid And " +
					" en_0251z00_bettype.bettypeid = en_0651c02_betstatus_bbl.bettypeid And " +
	                " en_0251z00_bettype.mainbettypeid = " + SportUtil.kBMBT_Handicap + " And " +
                    " en_0651c02_betstatus_bbl.scheduleid > 0 And " +
                    " en_0651b04_smartmasterinfo.unitid = " + arrInfo [f_CDCompanyUnitId] +
                    getDateCondition_PB (oFromDate, oToDate) +
                    getIgnoreClientCondition () +
                    oConditionPM +
                " Order By mastercode ";
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getStatusXML (T6_SmartMaster, 1, "HDPLiabilityBL:getSmartMasters:Successful"));
            }
            else
                oBuffer.append (getStatusXML (T6_SmartMaster, -1, "HDPLiabilityBL:getSmartMasters:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (T6_SmartMaster, -1, "HDPLiabilityBL:getSmartMasters" + oException.toString ()));
        }
    ...
    private String getSmartGroups ()
    {
        ...
        {            
			...
			UserSmartGroupPM_T1 objSmartGroupPM = new UserSmartGroupPM_T1 (getDocument ());
			String oSmartGroupIds_PM = objSmartGroupPM.getUserSmartGroupIds_PM (getUserId (), kModuleId, SportUtil.kS_BasketBall, convertToInt (arrInfo [f_CDCompanyUnitId]));
            ...
            String oSQL =             
                " Select Distinct en_0651b04_smartgroupinfo.smartid, " +
                    " en_0651b04_smartgroupinfo.groupcode " +
                " From en_0651b04_smartgroupinfo, en_0651c02_betstatus_bbl, en_0651c03_liabilityah_bbl, en_0251z00_bettype WITH (NOLOCK) " +
                " Where en_0651b04_smartgroupinfo.smartid = en_0651c02_betstatus_bbl.smartid And " +
                    " en_0651b04_smartgroupinfo.smartid = en_0651c03_liabilityah_bbl.smartid And " +
					" en_0251z00_bettype.bettypeid = en_0651c02_betstatus_bbl.bettypeid And " +
	                " en_0251z00_bettype.mainbettypeid = " + SportUtil.kBMBT_Handicap + " And " +
                    " en_0651c02_betstatus_bbl.scheduleid > 0 And " +
                    " en_0651b04_smartgroupinfo.unitid = " + arrInfo [f_CDCompanyUnitId] +
                    getDateCondition_PB (oFromDate, oToDate) +
                    getIgnoreClientCondition () +
                    oConditionPM +
                " Order By groupcode ";
            ...
            if (oResultSet != null)
            {
                ...
                oBuffer.append (getStatusXML (T7_SmartGroups, 1, "HDPLiabilityBL:getSmartGroups:Successful"));
            }
            else
                oBuffer.append (getStatusXML (T7_SmartGroups, -1, "HDPLiabilityBL:getSmartGroups:Unsuccessful"));
        }
        catch (Exception oException)
        {
            oBuffer.append (getStatusXML (T7_SmartGroups, -1, "HDPLiabilityBL:getSmartGroups" + oException.toString ()));
        }
