package enlj.p106trading.mssqlv51.p10651basketball.sbteamstatsex.logics;
...
{
    /* Module Id */
    private final String kModuleId = "106510420";    	
    
	/* Task Ids */
	private final String kInitData	    = "10651042001";
	private final String kSeasons	    = "10651042004";
	private final String kTeams	        = "10651042005";
 	private final String kTeamStatsEx   = "10651042006";
    ...
    private final String kCR_AgainstTop     = "sr4";
    private final String kCR_AgainstMiddle  = "sr5";
    private final String kCR_AgainstBottom  = "sr6";
    private final String kCR_Last6Match     = "cr7";
    private final String kCR_TeamMatch      = "cr8";
    private final String kCR_TeamHandicap   = "cr9";
    ...
    */   
    ...
    {
        StringBuffer oBuffer = new StringBuffer ();
        oBuffer.append (getAgainstTopList ());
        oBuffer.append (getAgainstMiddleList ());
        oBuffer.append (getAgainstBottomList ());
        oBuffer.append (getLast6MatchStatistics ());
        oBuffer.append (getTeamMatchStatistics ());
        oBuffer.append (getTeamHandicapStatistics ());
        
        return oBuffer.toString ();
    }    
    
    private String getLast6MatchStatistics ()
    {
		StringBuffer oBuffer = new StringBuffer ();

		String [] arrInfo = getParams (kCR_Last6Match);				
    ...
    private String getTeamMatchStatistics ()
    {
		StringBuffer oBuffer = new StringBuffer ();

		String [] arrInfo = getParams (kCR_TeamMatch);				
    ...
    private String getTeamHandicapStatistics ()
    {
		StringBuffer oBuffer = new StringBuffer ();

		String [] arrInfo = getParams (kCR_TeamHandicap);				
	...
	private String getAgainstTopList ()
    {        
        StringBuffer oBuffer = new StringBuffer ();

		String [] arrInfo = getParams (kCR_AgainstTop);				
	...
	private String getAgainstMiddleList ()
    {        
        StringBuffer oBuffer = new StringBuffer ();

		String [] arrInfo = getParams (kCR_AgainstMiddle);				
	...
	private String getAgainstBottomList ()
    {        
        StringBuffer oBuffer = new StringBuffer ();

		String [] arrInfo = getParams (kCR_AgainstBottom);				
